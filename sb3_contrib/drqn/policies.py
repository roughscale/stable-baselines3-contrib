...
class DRQNetwork(BasePolicy):
    ...
    def __init__(
        ...
        lstm_layers = nn.LSTM(self.features_dim, lstm_dim, num_layers)
        linear_layer = nn.Linear(lstm_dim, action_dim)
        self.q_net = nn.Sequential(lstm_layers, linear_layer)
